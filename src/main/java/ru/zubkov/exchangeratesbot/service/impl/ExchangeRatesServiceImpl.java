package ru.zubkov.exchangeratesbot.service.impl;
...
import ru.zubkov.exchangeratesbot.client.CbrClient;
...
public class ExchangeRatesServiceImpl implements ExchangeRatesService {
    ...
    @Cacheable(value = "cad", unless = "#result == null or #result.isEmpty()")
    @Override
    ...
    @CacheEvict("cad")
    @Override
    public void clearCADCache() {
        LOG.info("Cache \"cad\" cleared!");
    }
